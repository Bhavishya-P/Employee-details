...
public class MysqlImp implements Ff
{
    Connection con=null;
    Statement st=null;
	...
	public void initDB() throws SQLException, IOException {
		...
		try {
         ...
         con=DriverManager.getConnection("jdbc:mysql://localhost:3306/iprimed","root","0804");  
	...
	public int create(Employee e) throws SQLException
	{
		...
		pst=con.prepareStatement("insert into iprimed.employee values(?,?,?,?,?,?,?)");
		String get_empid="select coalesce((select max(id)+1 from iprimed.employee),1) as getid";
